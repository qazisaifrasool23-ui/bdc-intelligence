...
HISTORY_YEARS = 6  # back to ~Q1 2020
...
# ---- News coverage: only the 20 market-moving BDCs (traded + non-traded) ----
COVERAGE = [
    "ARCC", "OBDC", "FSK", "BXSL", "MAIN", "GBDC", "HTGC", "TSLX", "BCSF",
    "NMFC", "CGBD", "OBDE", "KBDC", "PSEC", "BBDC",
    "BCRED", "OTF", "HLEND", "OCIC", "NCDL",
]
# Non-traded funds have no ticker on the SEC map, so their CIK must be supplied
# here (10-digit, zero-padded). Fill any that are missing from fund_directory.
CIK_OVERRIDES = {
    # "BCRED": "0001803498",
    # "OTF":   "00000000..",
    # "HLEND": "00000000..",
